...
DATABASES = {
    'default': {
        ...
        'NAME': 'KHID',                      # Or path to database file if using sqlite3.,
        'USER': 'root',
        'PASSWORD' : 'password',
  }}
...
("KHID.views.dashboardView",  "Summary"),
("KHID.views.kunitDashboardView",  "KUnit Summary"),
("KHID.views.wardSummaryView",  "Ward Summary"),
("KHID.views.patientsView",  "Patients"),
("KHID.views.patientSymptomsView",  "Patient Symptoms"),
("KHID.views.hierarchysView",  "Hierarchy")
]
...
if 'test' in sys.argv:
    for db_name in DATABASES:
        DATABASES[db_name]['TEST_NAME'] = os.path.join(
            tempfile.gettempdir(),
            "%s.rapidsms.test.sqlite3" % db_name), "rapidsms_xforms"
